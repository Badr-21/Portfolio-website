...
const MyProjects = forwardRef(function MyProjects(props, myProjectsRef) {
   return (
      <section
         ref={myProjectsRef}
         className="py-16 w-full bg-AliceBlue flex flex-col gap-y-16 items-center"
      >
         <h2 className=" w-[60rem] text-4xl text-PictonBlue font-semibold mb-8">My Projects</h2>
         <article className="w-[60rem] h-[25rem] border flex overflow-hidden p-4 rounded-md shadow bg-white">
            <div className="w-[35rem] border rounded-md overflow-hidden">
               <a href="https://badr-21-platinum-gym.netlify.app/" target="_blank" rel="noreferrer">
                  <img
                     className=" h-[100rem] relative transition transform hover:translate-y-[-76rem] duration-7000 ease-in-out hover:cursor-pointer rounded-md"
            ...
            <div className="w-[25rem] px-8 py-4">
               ...
               <p className="text-DavysGray font-medium mb-4">
               ...
               <div className="flex gap-x-4 mb-4">
                  <p className="shadow border rounded-md p-1">TypeScript</p>
                  <p className="shadow border rounded-md p-1">React</p>
                  <p className="shadow border rounded-md p-1">Tailwind</p>
               </div>
         ...
         <article className="w-[60rem] h-[25rem] border flex flex-row-reverse overflow-hidden p-4 rounded-md shadow bg-white">
            <div className="w-[35rem] border rounded-md overflow-hidden">
               <a href="https://badr-21-book-tracker.netlify.app/" target="_blank" rel="noreferrer">
                  <img
                     className="w-[60rem] h-[85rem] relative transition transform hover:translate-y-[-63rem] duration-7000 ease-in-out hover:cursor-pointer rounded-md"
            ...
            <div className="w-[25rem] px-8 py-4">
               ...
               <div className="flex gap-x-4 mb-4">
                  <p className="shadow border rounded-md p-1">React</p>
                  <p className="shadow border rounded-md p-1">SCSS</p>
               </div>
         ...
         <article className="w-[60rem] h-[25rem] border flex overflow-hidden p-4 rounded-md shadow bg-white">
            <div className="w-[35rem] border rounded-md overflow-hidden">
               ...
               ></a>
               <img
                  className="w-[60rem] h-[80rem] relative transition transform hover:translate-y-[-57rem] duration-7000 ease-in-out hover:cursor-pointer rounded-md"
                  src={JobHuntImage}
