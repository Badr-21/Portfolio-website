...
const MyProjects = forwardRef(function MyProjects(props, myProjectsRef) {
   return (
      <section
         ref={myProjectsRef}
         className="py-16 w-full bg-AliceBlue flex flex-col gap-y-20 items-center"
      >
         <h2 className=" w-[60rem] text-4xl text-PictonBlue font-semibold self-start lg:px-36 px-8">
            My Projects
         </h2>
         <article className="lg:w-[60rem] lg:h-[25rem] md:w-[40rem] sm:w-[35rem] min-[445px]:w-[25rem] h-[35rem] w-[18rem] border flex lg:flex-row flex-col overflow-hidden p-4 rounded-md shadow bg-white">
